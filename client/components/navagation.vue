<template>
    <Disclosure as="nav" class="bg-gray-800" v-slot="{ open }">
            ...
            <div class="relative flex h-16 items-center justify-between">
                <div class="flex items-center px-2 lg:px-0">
                    <div class="flex-shrink-0">
                        <img class="h-8 w-auto" src="public/images/facebook.png"
                            alt="Your Company" />
                    </div>
                    <div class="hidden lg:ml-6 lg:block">
                        <div class="flex space-x-4 cursor-pointer">
                            ...
                            <a @click="navigateTo('/marketplace')"
                                class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Marketpalce</a>
                            <a @click="navigateTo('/message')"
                                class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Message</a>
                            <a @click="navigateTo('/menu')"
                                class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Menu</a>
                            <a @click="navigateTo('/video')"
                                class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Video</a>
                        </div>
                    </div>
                </div>
        ...
        <DisclosurePanel class="lg:hidden">
            <div class="space-y-1 px-2 pb-3 pt-2 cursor-pointer">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <DisclosureButton as="a" @click="navigateTo('/')"
                    class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Home
                </DisclosureButton>
                <DisclosureButton as="a" @click="navigateTo('/marketplace')"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                    Marketpalce</DisclosureButton>
                <DisclosureButton as="a" @click="navigateTo('/message')"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                    Message</DisclosureButton>
                <DisclosureButton as="a" @click="navigateTo('/menu')"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                    Menu</DisclosureButton>
                <DisclosureButton as="a" @click="navigateTo('/video')"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
